...
module CycledTrgGen(
    ...
    input   [7:0]	cycled_trg_period_in,//the Unit = 2^17* 40 nano-second, approximately 5.2ms. So the maximum period is 5.2ms*2^8 = 1.34s
...
reg[24:0]   cycled_trg_period_cnt;//the clk is 40Mhz
...
begin
    ...
    else if (cycled_trg_bgn_in) begin ///when receive the command, set the cycle_trg_enb_r = 1
