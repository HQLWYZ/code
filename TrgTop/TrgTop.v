...
wire    [7:0]   acd_csi_hit_tim_diff_sig; 
wire    [3:0]   acd_fee_top_hit_align_sig;
wire    [3:0]   acd_fee_sec_hit_align_sig;
wire    [3:0]   acd_fee_sid_hit_align_sig;
wire    [3:0]   csi_hit_align_sig;  
...
wire            eff_trg_sig, trg_sig_end_flag;
...
// For Coincidence_inst
wire [4:0]  w_logic_grp_oe_in;
assign w_logic_grp_oe_in = logic_grp_oe_sig[4:0];

// For TrgMonData_inst
wire [15:0] w_hit_monit_fix_sel_in;
assign w_hit_monit_fix_sel_in = {12'b0000_0000_0000, hit_monit_fix_sel_sig};

wire [15:0] w_hit_monit_sel_in;
assign w_hit_monit_sel_in = {8'b0000_0000, hit_monit_sel_sig};

wire [15:0] w_hit_monit_err_cnt_in;
assign w_hit_monit_err_cnt_in = {8'b0000_0000, hit_monit_err_cnt_sig};

wire [15:0] w_busy_monit_fix_sel_in;
assign w_busy_monit_fix_sel_in = {15'b000_0000_0000_0000, busy_monit_fix_sel_sig};

wire [15:0] w_busy_monit_err_cnt_in;
assign w_busy_monit_err_cnt_in = {8'b0000_0000, busy_monit_err_cnt_sig};

wire [15:0] w_busy_ab_sel_in;
assign w_busy_ab_sel_in = {14'b00_0000_0000_0000, busy_ab_sel_sig};

wire [15:0] w_busy_mask_in;
assign w_busy_mask_in = {14'b00_0000_0000_0000, busy_mask_sig};

wire [15:0] w_trg_dead_time_in;
assign w_trg_dead_time_in = {8'b0000_0000, trg_dead_time_sig};

wire [15:0] w_ext_trg_delay_in;
assign w_ext_trg_delay_in = {8'b0000_0000, ext_trg_delay_sig};

wire [15:0] w_cycled_trg_period_in;
assign w_cycled_trg_period_in = {8'b0000_0000, cycled_trg_period_sig};

// For TrgSciData_inst
wire [7:0]  w_trg_mode_mip1_in;
assign w_trg_mode_mip1_in = trg_mode_mip1_sig[7:0];

wire [7:0]  w_trg_mode_mip2_in;
assign w_trg_mode_mip2_in = trg_mode_mip2_sig[7:0];

wire [7:0]  w_trg_mode_gm1_in;
assign w_trg_mode_gm1_in = trg_mode_gm1_sig[7:0];

wire [7:0]  w_trg_mode_gm2_in;
assign w_trg_mode_gm2_in = trg_mode_gm2_sig[7:0];

wire [7:0]  w_trg_mode_ubs_in;
assign w_trg_mode_ubs_in = trg_mode_ubs_sig[7:0];
...
ConfigReg ConfigReg_inst(
    ...
    .data_trans_enb_out(data_trans_enb_sig),
    ...
    .trg_mode_mip1_out(trg_mode_mip1_sig),
    .trg_mode_mip2_out(trg_mode_mip2_sig),
    .trg_mode_gm1_out(trg_mode_gm1_sig),
    .trg_mode_gm2_out(trg_mode_gm2_sig),
    .trg_mode_ubs_out(trg_mode_ubs_sig),
    .trg_mode_brst_out(trg_mode_brst_sig),
...
Coincidence Coincidence_inst(
    ...
    .logic_grp_oe_in(w_logic_grp_oe_in),                  // <-- Modified
...
TrgOutCtrl TrgOutCtrl_inst(
    ...
    .trg_sig_end_flag(trg_sig_end_flag),
...
TrgMonData TrgMonData_inst(
    ...
    .hit_monit_fix_sel_in(w_hit_monit_fix_sel_in),      // <-- Modified
    .hit_monit_sel_in(w_hit_monit_sel_in),              // <-- Modified
    .hit_monit_err_cnt_in(w_hit_monit_err_cnt_in),      // <-- Modified
    .hit_start_cnt_in(hit_start_cnt_sig),
    .hit_monit_cnt_0_in(hit_monit_cnt_0_sig),
    .hit_monit_cnt_1_in(hit_monit_cnt_1_sig),
    .busy_monit_fix_sel_in(w_busy_monit_fix_sel_in),    // <-- Modified
    .busy_monit_err_cnt_in(w_busy_monit_err_cnt_in),    // <-- Modified
    ...
    .hit_ab_sel_in(hit_ab_sel_sig),
    .busy_ab_sel_in(w_busy_ab_sel_in),                  // <-- Modified
    .hit_mask_in(hit_mask_sig),
    .busy_mask_in(w_busy_mask_in),                      // <-- Modified
    .trg_match_win_in(trg_match_win_sig),
    .trg_dead_time_in(w_trg_dead_time_in),              // <-- Modified
    .config_received_in(config_received_sig),
    .ext_trg_delay_in(w_ext_trg_delay_in),              // <-- Modified
    .cycled_trg_period_in(w_cycled_trg_period_in),      // <-- Modified
...
(
    ...
    .trg_mode_mip1_in(w_trg_mode_mip1_in),              // <-- Modified
    .trg_mode_mip2_in(w_trg_mode_mip2_in),              // <-- Modified
    .trg_mode_gm1_in(w_trg_mode_gm1_in),                // <-- Modified
    .trg_mode_gm2_in(w_trg_mode_gm2_in),                // <-- Modified
    .trg_mode_ubs_in(w_trg_mode_ubs_in),                // <-- Modified
    .eff_trg_cnt_in(eff_trg_cnt_sig),
    .eff_trg_in(eff_trg_sig),
    .trg_sig_end_flag(trg_sig_end_flag),
