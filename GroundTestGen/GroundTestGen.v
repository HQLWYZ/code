...
module GroundTestGen(
	input			clk_in,
	input			rst_in_N,
    input           ext_trg_test_in_N,  //external trigger sources
    ...
    input           ext_trg_oe_in,      // external trigger output enable signal from configuration module
...
begin
    if (!rst_in_N) begin
        ...
        ext_trg_tmp0_r <= ~ext_trg_test_in_N;
...
assign	ext_trg_syn_out     = ext_trg_syn_r & ext_trg_oe_in;
